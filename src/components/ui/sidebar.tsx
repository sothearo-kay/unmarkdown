...
export const SidebarContext: React.Context<null | SidebarContextProps>
  = React.createContext<null | SidebarContextProps>(null);
...
export function SidebarMenuButton({
  ...
  isActive?: boolean;
  tooltip?: React.ComponentProps<typeof TooltipPopup> | string;
}): React.ReactElement {
